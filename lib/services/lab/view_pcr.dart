...
class pcrPass extends StatefulWidget {
  const pcrPass({
    Key? key,
    required this.Image,
    required this.name,
  ...
  @override
  State<pcrPass> createState() => _pcrPassState();
}

class _pcrPassState extends State<pcrPass> {
