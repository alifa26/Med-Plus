        ...
        children: [InkWell(onTap: (){selectFile();},
            ...
            child: Stack(alignment: AlignmentDirectional.bottomCenter,
              children:[Container(margin: EdgeInsets.only(top: 15),
                ...
                child: Padding(
                  ...
                  child: CircleAvatar(radius:130,backgroundColor: Colors.white, child: Image(image:AssetImage('images/lab.png'),),
                    ),
                ),
          ...
          Padding(
            ...
            child: TextFormField(
                        validator: (value) {
                          if (value!.isEmpty) {
                            return 'Lab name can not be empty';
                          }
           ...
           Padding(
            ...
            child: TextFormField(
                        validator: (value) {
                          if (value!.isEmpty) {
                            return 'Lab number can not be empty';
                          }
